...
# Break the navigation into sections
	$Nav->addCustomNav("Download", "/tycho/download.php", "_self", 3);
	$Nav->addCustomNav("Documentation", "/tycho/documentation.php", "_blank", 3);
	$Nav->addCustomNav("Support", "/tycho/support.php", "_blank", 3);
	$Nav->addCustomNav("Getting Involved", "/tycho/getting_involved.php", "_blank", 3);
