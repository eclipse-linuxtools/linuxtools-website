<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<li>JRE >= 11.0</li>
	        <li>Eclipse >= 4.2r</li>
		<li><a href="http://eclipse.org/cdt">CDT</a> >= 10.4.0</li>
		...
		<br/>&nbsp;&nbsp;&nbsp;Installations via the 2021-09 p2 aggregate repository will automatically get these dependencies.
		...
		<br/>&nbsp;&nbsp;&nbsp;<a href="http://git.eclipse.org/c/linuxtools/org.eclipse.linuxtools.git/tag/?id=v8.4.0">Source tarballs</a> for Linux Tools plugins.
		<ul>
			<li>
				<a title="p2 Main Repository Zip" href="downloads/linuxtools-8.4.0.zip">
					<img src="/linuxtools/images/icon-save.gif" alt="Download icon"/></a>
				&nbsp;&nbsp;(<a href="downloads/linuxtools-8.4.0.zip.md5">md5sum</a>)
				<b>http://download.eclipse.org/linuxtools/update-8.4.0</b>
			</li>
			<li>
				<a title="p2 Docker Tooling Repository Zip" href="downloads/linuxtools-docker-5.4.0.zip">
					<img src="/linuxtools/images/icon-save.gif" alt="Download icon"/></a>
				&nbsp;&nbsp;(<a href="downloads/linuxtools-docker-5.4.0.zip.md5">md5sum</a>)
				<b>http://download.eclipse.org/linuxtools/update-docker-5.4.0</b>
			</li>
		</ul>
		</div>
