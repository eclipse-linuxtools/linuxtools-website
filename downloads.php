<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	<div id="midcolumn">
		...
		<h3>8.3.0 Release&nbsp;<a title="More Info" href="http://wiki.eclipse.org/Linux_Tools_Project/PluginInstallHelp"><img src="/linuxtools/images/icon-help.gif" alt="Help icon" /></a></h3>
		<br/>&nbsp;&nbsp;&nbsp;<a href="https://wiki.eclipse.org/Linux_Tools_Project/News/NewIn83">New &amp; Noteworthy</a>.
		<a href="https://ci.eclipse.org/linuxtools/job/linuxtools-8.3/4/testReport/">Unit test results</a>.
		<br/>&nbsp;&nbsp;&nbsp;Requires:
		<ul>
		<li>JRE >= 11.0</li>
	        <li>Eclipse >= 4.20</li>
		<li><a href="http://eclipse.org/cdt">CDT</a> >= 10.3.0</li>
		...
		<br/>&nbsp;&nbsp;&nbsp;Installations via the 2021-06 p2 aggregate repository will automatically get these dependencies.
		...
		<br/>&nbsp;&nbsp;&nbsp;<a href="http://git.eclipse.org/c/linuxtools/org.eclipse.linuxtools.git/tag/?id=v8.3.0">Source tarballs</a> for Linux Tools plugins.
		<ul>
			<li>
				<a title="p2 Main Repository Zip" href="http://www.eclipse.org/downloads/download.php?file=/linuxtools/linuxtools-8.3.0.zip">
					<img src="/linuxtools/images/icon-save.gif" alt="Download icon"/></a>
				&nbsp;&nbsp;(<a href="http://download.eclipse.org/linuxtools/linuxtools-8.3.0.zip.md5">md5sum</a>)
				<b>http://download.eclipse.org/linuxtools/update-8.3.0</b>
			</li>
			<li>
				<a title="p2 Docker Tooling Repository Zip" href="http://www.eclipse.org/downloads/download.php?file=/linuxtools/linuxtools-docker-5.3.0.zip">
					<img src="/linuxtools/images/icon-save.gif" alt="Download icon"/></a>
				&nbsp;&nbsp;(<a href="http://download.eclipse.org/linuxtools/linuxtools-docker-5.3.0.zip.md5">md5sum</a>)
				<b>http://download.eclipse.org/linuxtools/update-docker-5.3.0</b>
			</li>
		</ul>
		</div>
